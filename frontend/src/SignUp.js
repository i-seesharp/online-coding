            ...
            <div className="float-right mb-80 flex-2 mr-60 max-h-10">
                ...
                <form onSubmit={this.handleSubmit} className="bg-black shadow-md rounded px-8 pt-6 pb-8 mb-4">
                  ...
                  <div className="mb-6">
                    ...
                    <input onChange={this.handleChange} value={this.state.confirm} name="confirm" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="confirm" type="password" placeholder="******************" />
                  </div>
